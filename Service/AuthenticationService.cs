...
internal sealed class AuthenticationService : IAuthenticationService
{
    ...
    {
        var key = Encoding.UTF8.GetBytes(Environment.GetEnvironmentVariable("SECRETExpense"));
    ...
    private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
    {
        var tokenValidationParameters = new TokenValidationParameters
        {
            ...
            IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(Environment.GetEnvironmentVariable("SECRETExpense"))),
